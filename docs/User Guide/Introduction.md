...
### Interface Designer
Visualization and user controls are grouped in interfaces for letting the user interact with our app. In this chapterthen further interaction is defined how to create user interfaces for interacting with data analytics apps
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTMzNjQyNTAsMzkwOTEzMTM0LDExOT
