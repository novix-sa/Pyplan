...
### Interface Designer
Visualization and user controls are grouped in interfaces for letting the user interact with your app and explore results. In this chapter then further interaction is defined how to create user interfaces for interacting with data analytics apps
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU4ODgyOTg0MywzOTA5MTMxMzQsMTE5NT
