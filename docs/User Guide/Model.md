...
Index defined in Pyplan have an additional function when creating User Interfaces where output share dimensions.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM3MjE1NDQ0Miw4ODY1OTM3MTIsLTM3Nj
