...
Additionally, Pyplan encourage a the usage of Index for defining dimensions for Xarray datin a different manner than how it is used
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMjM2NDE3NzksLTE4NDM0OTgxNzZdfQ
==
-->