...
As a first step, drag and drop a "Node" into the canvas, provide a Title:"My first node" and lets inspect its attribute tabs.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQzNDI5NTcwNywtMjAxMTcwMTM0NiwxND
