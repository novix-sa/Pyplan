...
![enter image description here](img src="http://img.pyplan.org/Quick_start_pencil.png height=%22200px%22%20/%3E)
...
When you ask for a node to be run, Pyplan trace all predecesor variables and run them in sequence in order to have computed every input that this node needs. The results of intermediate nodes are preserved in memory for future inspection. When the definition of a node change, all downstream nodes are marked to be recalculated so the user does not need to be aware about the updated value of any predecesor when running a node.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzI2NTY2NzAsNjIyMjg3NzIxLC0xNTI2Nj
IxMzAyLC01NjY4NTUwOSwxNTcxNzc5NTI3LC0yMDEyODY1ODcz
LC0xOTY4OTAyMjc3LC0xMzYxMDIwNzQyLDE2ODM2MjcxMTAsLT
E0MTcyNDk5NTUsLTI2MTE2OTg1MywtNTI2OTc0NzA0LDg2NDQ1
NzA1MywxMjU4ODk0MzgzLDEzMzU0NjIxMTAsMTk4ODk5MTM5Ny
wtMjAxMjE1NjAsLTk5ODc0NDA0OCwtMTE1NDA2ODk2LDE1OTc1
NjM5NDBdfQ==
-->